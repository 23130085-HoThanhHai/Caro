...
// -	4.7: Server gọi nghiệp vụ tham gia phòng theo mã
// 	Chuyển giao Logic: Controller gọi xuống tầng Business (Service) để xử lý nghiệp vụ cốt lõi
// , truyền vào authUser và roomCode.
public final class RoomService {
    ...
    // -	4.8: Service validate và chuẩn hoá mã phòng
// 	Làm sạch dữ liệu: Tầng Service thực hiện loại bỏ khoảng trắng thừa (trim)
//  và chuyển toàn bộ chuỗi sang in hoa (UPPERCASE) để đồng nhất dữ liệu.
